...
%     scatter(out.intMatrixX(:),out.intMatrixY(:),[],'r');
    scatter(out.intMatrixXY(1,:),out.intMatrixXY(2,:),'filled','d');
...
%     hL1 = line([XY1(I,1)';XY1(I,3)'],[XY1(I,2)';XY1(I,4)'],'Color','r','LineWidth',10);
%     hL2 = line([XY2(J,1)';XY2(J,3)'],[XY2(J,2)';XY2(J,4)'],'Color','k');
    
    plot([XY1(I,1)';XY1(I,3)'],[XY1(I,2)';XY1(I,4)'],'Color','r','LineWidth',3);
    hold on;
    plot([XY2(J,1)';XY2(J,3)'],[XY2(J,2)';XY2(J,4)'],'Color','k');
...
%     axes(axes_properties,'parent',gcf);
    ...
    [I1,J1] = find(out.coincAdjacencyMatrix);
    
    plot([XY1(I1,1)';XY1(I1,3)'],[XY1(I1,2)';XY1(I1,4)'],'Color','r','LineWidth',3);
     hold on;
    plot([XY2(J1,1)';XY2(J1,3)'],[XY2(J1,2)';XY2(J1,4)'],'Color','k');
